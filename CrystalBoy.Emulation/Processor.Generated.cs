					...
					switch (opcode)
					{
						...
						case 0xCA: /* JP Z,N */
							...
							if (zeroFlag)
							{
								...
								cycleCount = 12;
							break;
						case 0xCB: /* Extended opcodes */ opcode = bus.ReadByte(pc++);
							switch (opcode)
							{
								case 0x00: /* RLC B */
									carryFlag = (b & 0x80) != 0;
						...
						case 0xF8: /* LD HL,SP+N */
							__temp16 = (ushort)(sp + (sbyte)bus.ReadByte(pc++));
							__tempHL = __temp16;
							h = (byte)(__tempHL >> 8); l = (byte)(__tempHL);
							zeroFlag = false;
							negationFlag = false;
						...
						case 0xFF: /* RST $38 */
							...
							break;
						default:
							throw new InvalidOperationException("Invalid opcode: " + opcode.ToString("X2"));
					}
				HandleBreakpoints:
#if WITH_DEBUGGING
